...
var VoiceUDPSocket = class extends TypedEmitter {
...
var Networking = class extends TypedEmitter3 {
...
var AudioPlayer = class extends TypedEmitter4 {
  constructor(options = {}) {
    super();
    __publicField(this, "_state");
...
var VoiceConnection2 = class extends TypedEmitter7 {
...
function version(name) {
  try {
    const pkg = name === "@discordjs/voice" ? require_package() : findPackageJSON(dirname(__require.resolve(name)), name, 3);
...
function demuxProbe(stream, probeSize = 1024, validator = validateDiscordOpusHead) {
  return new Promise((resolve2, reject) => {
    ...
    const finish = /* @__PURE__ */ __name((type) => {
      ...
      if (stream.readableEnded) {
        resolve2({
          stream: Readable3.from(readBuffer),
          type
        });
      } else {
...
export {
  ...
  SpeakingMap,
  StreamType,
  VoiceConnection2 as VoiceConnection,
  VoiceConnectionDisconnectReason,
  VoiceConnectionStatus,
  VoiceReceiver,
  createAudioPlayer,
